...
export class Page3Component implements OnInit{
  ...
  navigateToPage4() {
    this.router.navigate(['/page4'], { queryParams: { dateArrivee: this.dateArrivee, dateDepart: this.dateDepart, nbrChambre: this.nbrChambre, nbrPersonne: this.nbrPersonne  } });
  }
  
  storeReservationData(data: any): void {
    let reservation = {
  ...
  this.sharedService.setReservationData(reservation);
  this.navigateToPage4();
}
